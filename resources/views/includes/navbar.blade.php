    ...
    <div class="container clearfix">
        ...
        <div class="logo-box clearfix">
            <a class="navbar-brand" href="{{route('home')}}">
                <img src="{{asset("assets/FrontEnd/images/logo-icbs.jpg")}}" class="main-logo" width="168" alt="Awesome Image" />
            </a>
            <div class="header__social">
                <a href="#"><i class="fab fa-twitter"></i></a>
                <a href="{{url('https://www.facebook.com/icbsinternational2017')}}"><i class="fab fa-facebook-square"></i></a>
