...
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Front Banner </h3>
    ...
    <div class="row">
        ...
        <div class="col-md-6 grid-margin">
            <div class="card">
                <div class="card-body text-center">
                    <img id="preview_bg_imageImage" src="admin/assets/images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                    <form class="form-sample" id="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slogan" name="slogan" placeholder="Name">
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script src="{{ url('admin/assets/js/custom/frontBanner.js') }}"></script>
@endsection
